...
@swagger_auto_schema(
    ...
    operation_description="Create a post with an optional base64-encoded image, FEN notation, and text content. Requires authentication.",
    ...
    responses={
        ...
        400: openapi.Response(
            ...
            examples={
                'application/json': {
                    'post_image': ['Invalid base64 image format.'],
